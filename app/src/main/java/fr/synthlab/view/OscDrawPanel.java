 ...
 */
public class OscDrawPanel extends Pane {
    SwingNode swingNode;

    public OscDrawPanel() {
		super();
		swingNode = new SwingNode();
		SeeOscillators osc = new SeeOscillators();
		osc.start();
        swingNode.setContent(new JButton("Toppest of keks"));
        //swingNode.setContent(new SeeOscillators());
        this.getChildren().add(swingNode);
	}
}

class SeeOscillators extends JComponent
{
